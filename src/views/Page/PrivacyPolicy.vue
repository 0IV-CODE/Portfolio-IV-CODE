<template>
  <v-row>
    <v-col cols="0" lg="1" xl="2" class="d-md-none d-lg-flex"></v-col>
    <v-col cols="12" lg="10" xl="8" align="center">
      <v-card
        width="80%"
        elevation="4"
        ...
        align="start"
      >
        <p class="text-h2 text-center blue--text"><b>Privacy Policy</b></p>
        <p class="pt-4">
          <b
            >Your privacy is important to us. It is IV-CODE's policy to respect
            ...
            including across our website, https://iv-code.io, and other sites we
            own and operate.
            <a
            ...
            >, and other sites we own and operate.</b
          >
        </p>
        <p>
          This policy is effective as of 29 June 2022 and was last updated on 29
          June 2022.
        </p>
        <p class="text-h5 pt-4"><b>Information We Collect</b></p>
        <p>
        ...
        <p class="text-h5 pt-4"><b>Log Data</b></p>
        <p>
        ...
        <p class="text-h5 pt-4"><b>Personal Information</b></p>
        <p>
        ...
        <p class="text-h5 pt-4">
          <b>Legitimate Reasons for Processing Your Personal Information</b>
        </p>
        <p>
        ...
        <p class="text-h5 pt-4"><b>Collection and Use of Information</b></p>
        <p>
        ...
        <p class="text-h5 pt-4">
          <b>Security of Your Personal Informations</b>
        </p>
        <p>
        ...
        <p class="text-h5 pt-4">
          <b>How Long We Keep Your Personal Information</b>
        </p>
        <p>
        ...
        <p class="text-h5 pt-4">
          <b>International Transfers of Personal Information</b>
        </p>
        <p>
        ...
        <p>Isaac</p>
        <v-btn class="blue white--text pa-4" link to="/Contact">
          Contact Me</v-btn
        >
      </v-card>
    </v-col>
